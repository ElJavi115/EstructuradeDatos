...
public class MetodosOrdenamiento {
    ...
    public static void main(String[] args) 
	{
		...
		MetodosOrdenamiento main = new MetodosOrdenamiento();
		
		double inicio = 0, fin = 0, tiempo = 0; 
       ...
       for (int i = 0; i < array.length; ++i)
		...
		System.out.print("Ingrese el método que desee utilizar: ");
		int op = sc.nextInt();
		...
		switch(op)
		{
			...
			case 4:
				...
				main.radixsort(array, array.length);
				//main.imprimirArray(array);
			...
			case 5:
				...
				main.sort(array, 0, array.length - 1);
				//main.imprimirArray(array);
			...
			case 6:
				...
				main.dualPivotQuickSort(array, 0, array.length - 1);
				//main.imprimirArray(array);
